...
$sqlInsertPost= 'insert INTO post (titre, categorie, type, text, link, linkYoutube, linkDownload, img, User_idUser) VALUES (:titre, :categorie, :type, :text, :link, :linkYoutube, :linkDownload, :img, :User_idUser)';
