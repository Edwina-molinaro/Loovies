...
$sqlSelectPostDelete="SELECT * FROM post WHERE type = 'Build'";
  ...
  <link rel="stylesheet" href="../../public/css/main.css">
    ...
    <body>
        ...
        <div class="container-20 section-background d-flex justify-content-center align-items-center ">
            <div class="row">
                <div class="col-12">
                    <h2 class="title-banner"><span class="Letter"> B</span>uild Panel</h2>
                </div>
            </div>
        </div>

        <!-- //// REQUETE SLQ INSERT POUR LA PAGE 'BUILD.PHP' //// -->
        <div class="container mt-5">
            <form action="build-panel_base.php" method="POST">
                <div class="form-group">
                    <label for="exampleFormControlInput1">Title Build</label>
                    <input type="title" name="titre" class="form-control" id="exampleFormControlInput1" placeholder="Cute Build">
                </div>
                ...
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Link Last Video</label>
            ...
            <!-- //// REQUETE SLQ UPDATE POUR LA PAGE 'BUILD.PHP' //// -->
            <h2 class="text-center mt-5">Modify Build</h2>          
            <form action="animation-modify.php" method="POST">
                <div class="form-group">
                    <label for="exampleFormControlSelect1">Builds</label>
            ...
            <!-- //// REQUETE SLQ DELETE POUR LA PAGE 'BUILD.PHP' //// -->
            <h2 class="text-center mt-5">Delete Build</h2>          
            <form action="post-delete_base.php" method="POST">
                <div class="form-group">
                    ...
                    while($post = $reqSelectPostDelete->fetchObject()){ 
                    ?>  
                    <option><?php echo $post->titre ?></option>
                    <?php } ?>
                    </select>
