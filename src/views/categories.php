  ...
  <link rel="stylesheet" href="../../public/css/main.css">
    ...
    <body>
        ...
        <div class="container-20 section-background d-flex justify-content-center align-items-center ">
            <div class="row">
                <div class="col-12">
                    <h2 class="title-banner"><span class="Letter"> C</span>ategories Panel</h2>
                </div>
            </div>
        </div>

        <div class="container mt-5">
            <form action="categories_base.php" method="POST">
                <div class="form-group">
                    <label for="exampleFormControlInput1">Categorie</label>
                    <input type="title" name="name" class="form-control" id="exampleFormControlInput1" placeholder="New Categorie">
                </div>
