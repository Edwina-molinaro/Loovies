    ...
    <body>
        ...
        <header class="background">
            <nav class="navbar navbar-expand-lg  d-flex justify-content-around">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="animations.php">Animations<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row">
            <div class="col-12 text-center mt-5">
                <i class="mt-5 far fa-check-circle"></i>
            </div>
            <div class=" col-12 text-center">
                <h2>Tested Animations</h2>
            </div>
        </div>
        ...
        <?php while($post = $reqSelectPost->fetchObject()){ ?>
            ...
            <input class="mt-5 invisible" name="idpost" value=<?php echo $post->idpost ?>>
            <div class="container mt-5">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 selection_img">
                        <img src=<?php echo $post->img ?> alt="post picture">
                    </div>
